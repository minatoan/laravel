...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('order-get', $customer->matc)}}" class="brand-link">
        <!-- <img src="{{asset('dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">            -->
            <i class="fas fa-mug-hot"  style="padding-left:30px"><span  class="brand-text font-weight-light">   {{$customer->tochuc->tentc}}</span></i>
    </a>
    <base href="{{asset('')}}">
    <!-- Sidebar -->
    <div class="sidebar">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{route('get-xuathang-theo-tochuc', [$customer->matc, $customer->id])}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Xuất kho</p>
                            </a>
                        </li>
